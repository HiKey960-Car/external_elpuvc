...
int main(int argc, char *argv[])
{
	...
	if(do_h264_mode_get)
	{
		XU_H264_Get_Mode(dev, (int*) &h264_mode);
	}
	...
	for (i = 0; i < nframes; ++i) {
		...
		if(multi_stream_enable)
		{
			h264_decode_seq_parameter_set(((unsigned char*)mem0[buf0.index])+4, buf0.bytesused, (int*) &multi_stream_width, (int*) &multi_stream_height);
